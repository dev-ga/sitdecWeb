<div class="bg-black">
    <div class="animate-fade animate-once animate-duration-[1000ms] animate-ease-out animate-alternate h-screen font-poppins antialiased selection:bg-black selection:text-[#b4a9ff] bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/img1.jpg') }}');">
        <div class="relative flex flex-col justify-start items-start h-screen">
            ...
            <div class="flex justify-between items-center absolute bottom-0 top-0 w-full max-w-4xl p-10 animate-fade-left animate-once animate-duration-[800ms] animate-delay-300 animate-ease-linear animate-alternate">
                ...
                <img src="{{ asset('images/textoUno.png') }}" class="" alt="">
            </div>
